    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="Nos reunimos para entender tus objetivos, tu audiencia y las funcionalidades clave. Definimos la estructura, navegación y contenido antes de escribir una sola línea de código."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="Desarrollo y Actualizaciones"
          icon={<AceternityIcon order="Fase 2" />}
          des="Con el plan aprobado, me pongo a trabajar. Desde los primeros avances hasta el código final, te mantengo informado en cada etapa del proceso con total transparencia."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Aquí es donde todo cobra vida. Traduzco el diseño aprobado en código funcional, construyo el producto de principio a fin y lo dejamos listo para producción."
        >
          <CanvasRevealEffect
            animationSpeed={3}
